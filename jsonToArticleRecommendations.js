...
articleRecommendations.forEach(rec => {
    href = 'article?code=vX4RJPEMviAFcEE4u7QV1ualG0KakeZGISTdVpLFMtd93e0v52f7jw==&article=' + rec.title + '&previousPage=' + (window.location.href.split('==')[1] + '==' + window.location.href.split('==')[2]).replace('&', 'AMPERSAND').replace('?', 'QUESTION');
